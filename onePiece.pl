...
%1
participacionAlMismoEvento(Tripulacion1, Tripulacion2, Evento):-
    impactoEnRecompensa(Pirata1, Evento, _),
    tripulante(Pirata1, Tripulacion1),
    impactoEnRecompensa(Pirata2, Evento, _),
    tripulante(Pirata1, Tripulacion2),
